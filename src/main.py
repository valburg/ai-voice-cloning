...
if __name__ == "__main__":
    ...
    args = setup_args()
    args.listen_host = "0.0.0.0"  # Make the server listen on all network interfaces
    ...
    if args.listen_path is not None and args.listen_path != "/":
        ...
        webui = setup_gradio()
        webui.launch(share=args.share, prevent_thread_lock=True, show_error=True, server_name=args.listen_host, server_port=args.listen_port, enable_queue=True)
